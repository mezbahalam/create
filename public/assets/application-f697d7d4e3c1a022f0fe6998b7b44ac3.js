...
;(function(document, window) {
  ...
  var Shirt = React.createClass({displayName: "Shirt",
    getInitialState: function(){
      ...
      if (this.props.shirtState == "button"){
        return(
          React.createElement("div", {className: className}, 
              React.createElement("button", {className: "upload-butt "+buttonClass, onClick: this.handleButtonClick}, "+"), 
            React.createElement("div", {className: "buttons"}, 
              React.createElement("button", {className: "color color-white", onClick: this.handleColorClick, value: "white"}), 
              React.createElement("button", {className: "color color-black", onClick: this.handleColorClick, value: "black"}), 
              React.createElement("button", {className: "color color-blue", onClick: this.handleColorClick, value: "blue"}), 
              React.createElement("button", {className: "color color-green", onClick: this.handleColorClick, value: "green"}), 
              React.createElement("button", {className: "color color-orange", onClick: this.handleColorClick, value: "orange"}), 
              React.createElement("button", {className: "color color-pink", onClick: this.handleColorClick, value: "pink"}), 
              React.createElement("button", {className: "color color-purple", onClick: this.handleColorClick, value: "purple"}), 
              React.createElement("button", {className: "color color-red", onClick: this.handleColorClick, value: "red"}), 
              React.createElement("button", {className: "color color-yellow", onClick: this.handleColorClick, value: "yellow"})
            )
          )
        )
      }
        ...
        return(
          React.createElement("div", {className: className}, 
            React.createElement("div", {className: "canvas", style: {paddingTop:this.state.pixelsFromTop}}, 
              React.createElement("img", {src: this.props.image})
            ), 
            React.createElement("div", {className: "positioner"}, 
              React.createElement("button", {onClick: this.handleUpClick}, React.createElement("i", {className: "fa fa-sort-asc"})), 
              React.createElement("div", {className: "inches"}, " ", this.state.inchesFromTop+'"'), 
              React.createElement("button", {onClick: this.handleDownClick}, React.createElement("i", {className: "fa fa-sort-desc"}))
            ), 
            React.createElement("div", {className: "buttons after-upload"}, 
              React.createElement("button", {className: "color color-white", onClick: this.handleColorClick, value: "white"}), 
              React.createElement("button", {className: "color color-black", onClick: this.handleColorClick, value: "black"}), 
              React.createElement("button", {className: "color color-blue", onClick: this.handleColorClick, value: "blue"}), 
              React.createElement("button", {className: "color color-green", onClick: this.handleColorClick, value: "green"}), 
  ...
  var Form = React.createClass({displayName: "Form",
    ...
    render: function(){
      ...
      if(this.state.cardType && (this.state.cardType != "unknown")){
        cardDiv = React.createElement("div", {className: "card-type"}, this.state.cardType)
      }

      return(
        React.createElement("form", {onSubmit: this.handleSubmit, acceptCharset: "UTF-8", method: "post", encType: "multipart/form-data", action: "/uploads", ref: "form"}, 
          React.createElement("div", {className: "half"}, 
            React.createElement(Shirt, {
          ...
          React.createElement("div", {className: "half second"}, 
            React.createElement("input", {type: "file", name: "image", className: "shirt-file", ref: "file", onChange: this.handleFileChange}), 
            React.createElement("input", {type: "hidden", name: "inches", value: this.state.inches}), 
            React.createElement("input", {type: "hidden", name: "color", value: this.state.color}), 
            React.createElement("input", {type: "hidden", name: "stripeToken", value: this.state.stripeToken}), 
            React.createElement("input", {type: "text", className: shirtNameClass, name: "shirt_name", placeholder: "T-Shirt Title", onChange: this.handleTyping, ref: "shirtName", id: "shirtName", value: this.state.shirtName}), 
            React.createElement("div", {className: "shirt-title-caption"}, React.createElement("sup", null, "Please use the same t-shirt title that you will be using on Bandcamp")), 
            React.createElement("input", {type: "text", className: bandNameClass, name: "band_name", placeholder: "Artist / Band Name", onChange: this.handleTyping, ref: "name", id: "name", value: this.state.bandName}), 
            React.createElement("input", {type: "text", className: bandUrlClass+" halfplus-input", name: "bancamp_url", placeholder: "Bandcamp URL", onChange: this.handleTyping, id: "url", value: this.state.bandcampUrl}), " ", React.createElement("span", {className: "bigg"}, ".bandcamp.com"), 
            React.createElement("input", {type: "text", className: emailClass, name: "email", placeholder: "Email", onChange: this.handleTyping, id: "email", value: this.state.email}), 
            React.createElement("hr", null), 
            React.createElement("input", {type: "text", className: fullNameClass, name: "full_name", placeholder: "Full Name", ref: "full_name", value: this.state.fullName, id: "fullName", onChange: this.handleTyping}), 
            React.createElement("input", {type: "text", placeholder: "Credit Card Number", ref: "cc_number", className: numberClass, onBlur: this.validateCard, id: "ccn", value: this.state.ccNumber, onChange: this.handleTyping}), 
            cardDiv, 
            React.createElement("div", {className: "eighty"}, 
              React.createElement("input", {placeholder: "MM", ref: "month", className: "quarter-input "+yearClass, onBlur: this.validateYear, id: "month", value: this.state.month, onChange: this.handleTyping}), 
  ...
  var FormWrapper = React.createClass({displayName: "FormWrapper",
    getInitialState: function(){
    ...
    render: function(){
      ...
      if (this.state.submitting){
        loader = React.createElement("div", {className: "loader"}, 
          React.createElement("img", {alt: "Loading", className: "loader-image", src: "https://tonethreads.com/images/loading-d0df7f4e35df4273f32a597238bb9678.gif"}), 
          React.createElement("div", {className: "on-call-loader-text"}, "loading"
          )
        )
      }
      return(
  ...
  $(document).ready(function(){
    ...
    React.render(React.createElement(FormWrapper, null),document.getElementById('container'));
